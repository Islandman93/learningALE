...
For linux: It requires the C wrapper library to be built and on shared object path, as "ale_c_wrapper.so"
For windows: It requires ALE.dll in the learningALE/libs path
"""
